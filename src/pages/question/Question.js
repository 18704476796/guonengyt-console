...
export default {
  ...
  methods: {
    ...
    edit (item) { // 编辑管理员弹层函数
      ...
      this.formEdit.moreAndOne = item.moreAndOne
  ...
  data () {
    return {
      ...
      rules: { // 表单验证.
        title: [{ required: true, message: '请输入题目', trigger: 'blur' }], // 帐号验证
        content: [{ required: true, message: '请输入答案', trigger: 'blur' }], // 帐号验证
        moreAndOne: [{ required: true, message: '请选择题目类型', trigger: 'change'}] // 题目类型
      },
