  ...
  <div class="box">
    ...
    <el-drawer
      ...
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" style="padding: 0 10px;">
        ...
        <el-form-item label="序号" label-width="60px" prop="newsSort">
        ...
        <el-form-item>
          <div>请编辑内容：</div>
          <editor-bar v-model="ruleForm.content" :isClear="isClear" @change="change"></editor-bar>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="onSubmit" style="margin-left: 200px;">立即创建</el-button>
        </el-form-item>
      </el-form>
    </el-drawer>
    <el-dialog title="编辑案例" :visible.sync="dialogFormVisible" width="740px" :rules="ruless">
      <el-form :model="formEdit" ref="formEdit" :rules="rules">
        ...
        <el-form-item>
          <div>请编辑内容：</div>
          <editor-bar v-model="formEdit.content" :isClear="isClear" @change="change"></editor-bar>
        </el-form-item>
      </el-form>
...
<script src="./CustomerCase.js"></script>
<style lang="stylus" scoped src="./CustomerCase.css"></style>
