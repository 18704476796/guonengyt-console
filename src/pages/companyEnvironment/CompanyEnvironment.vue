...
<template>
  <div class="box">
    <div class="companyInfo hyb_clear">
      <div class="comButton">
        <el-button-group>
          <el-button type="primary" icon="el-icon-edit" @click="edit(tableData[0])">编辑环境介绍</el-button>
        </el-button-group>
      </div>
    ...
    <el-dialog title="公司环境" :visible.sync="dialogFormVisible" width="740px" :rules="ruless">
...
<script src="./CompanyEnvironment .js"></script>
<style lang="stylus" scoped src="./CompanyEnvironment .css"></style>
