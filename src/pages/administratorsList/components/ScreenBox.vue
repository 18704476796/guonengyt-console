<template>
  <div class="screenBox hyb_clear">
    ...
    <div class="right">
      <!-- <el-dropdown @command="changeCheckType" size="small" split-button type="primary">
        <span class="el-dropdown-link" style="color: #FFF;">
          {{checkTypeName}}
        </span>
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item  v-for="item in checkTypeList" :key="item.id" :command="item.name+'-'+item.id">{{item.name}}</el-dropdown-item>
          </el-dropdown-menu>
      </el-dropdown> -->
      <el-button type="primary" icon="el-icon-user" @click="administratorsAdd">新建管理员</el-button>
    </div>
  </div>
</template>
